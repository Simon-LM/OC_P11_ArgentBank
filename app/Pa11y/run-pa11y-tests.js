...
const urlsToTest = [
  {
    ...
    pa11yOptions: {
      screenCapture: path.join(
        __dirname,
        "screenshots/success",
        generateTimestampedFilename("home-page"),
      ),
    },
  },
  {
    ...
    pa11yOptions: {
      screenCapture: path.join(
        __dirname,
        "screenshots/success",
        generateTimestampedFilename("signin-page"),
      ),
    },
  },
  {
  ...
  },
  {
    ...
    postAuthActions: [
      `screenCapture ${path.join(__dirname, "screenshots/success", generateTimestampedFilename("user_page_after_auth"))}`, // On garde seulement la capture
    ],
    pa11yOptions: {
      screenCapture: path.join(
        __dirname,
        "screenshots/success",
        generateTimestampedFilename("user-page"),
      ),
    },
  },
];

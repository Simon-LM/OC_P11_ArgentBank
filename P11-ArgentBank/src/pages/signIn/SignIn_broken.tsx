...
impor				<p className={signin["signin-form__demo-info"]}>
				...
				</p>vigate } from "react-router-dom";
		...
		<div className={signin["signin-page"]}>
			<section className={signin["signin-form"]}>
				...
				<p className={signin["signin-form__demo-info"]}>
					{/* <i className="fa fa-info-circle" aria-hidden="true"></i> */}
					<LazyIcon name="FaInfoCircle" aria-hidden="true" />
					...
					<div className={signin["signin-form__input-group"]}>
						...
						<div className={signin["signin-form__password-field"]}>
							...
							<button
								...
								aria-label={showPassword ? "Hide password" : "Show password"}>
								{showPassword ? (
									<LazyIcon name="FaEyeSlash" aria-hidden="true" />
								) : (
									<LazyIcon name="FaEye" aria-hidden="true" />
								)}
							</button>
						</div>
					</div>
